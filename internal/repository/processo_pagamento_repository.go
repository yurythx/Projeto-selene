...
type ProcessoPagamentoRepository interface {
	...
	ListByEtapa(ctx context.Context, etapaID int) ([]models.ProcessoPagamento, error)
...
func (r *gormProcessoPagamentoRepository) ListByEtapa(ctx context.Context, etapaID int) ([]models.ProcessoPagamento, error) {
	...
	if err != nil {
		return nil, fmt.Errorf("repository: listar processos por etapa: %w", err)
	}
